...
!function (a, b, c) {
    ...
    !function (a) {
        ...
        a.widget("mobile.loader", {
            ...
            defaultHtml: "<div class='" + b + "'><div><span class='ui-icon-loading'></span><h1></h1></div></div>",
        ...
        function h() {
            ...
            return e.length ? g = e.attr("href") : e = f = a("<base>", {href: d}).appendTo("head"), b = a("<a href='../../css/lib/testurl' />").prependTo(m), c = b[0].href, e[0].href = g || location.pathname, f && f.remove(), 0 === c.indexOf(d)
        }
