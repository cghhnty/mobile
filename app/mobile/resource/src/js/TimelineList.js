	...
	$.when(
		(function() {
			if (me.isSelf) {
				...
				return api.get('member/getMember', {memberId: query.memberId}).done(function(err, member) {
					me.memberName = member.fullName;
				});
			}
		})(),

		api.get('timeline/getList', {memberId: query.memberId}).done(function(err, result) {
