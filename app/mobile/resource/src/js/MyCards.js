function MyCards(opts) {
    ...
    var cardStyles = {
        'STAMP_CARD': {ACTIVE: 'card-stamp', EXPIRED: 'stamp-card-inactive'},
        'PERIOD_CARD': {ACTIVE: 'card-period', EXPIRED: 'period-card-inactive'},
        'DISCOUNT_CARD': {ACTIVE: 'my-discount-card', EXPIRED: 'my-discount-card-expired'},
        'BALANCE_CARD': {ACTIVE: 'my-balance-card ', EXPIRED: 'my-balance-card-expired'}
    };

    //api.get('member/getMemberEx').done(function (err, memberEx) {
    //    me.cards = memberEx.cards;
    //    var now = Date.now();
    ...
    //
    //    });
    //    me.cards = me.cards.filter(function (card) {
    //        return card.type in {STAMP_CARD: 1, PERIOD_CARD: 1, BALANCE_CARD: 1, DISCOUNT_CARD: 1};
    //    });
    //    me.render();
