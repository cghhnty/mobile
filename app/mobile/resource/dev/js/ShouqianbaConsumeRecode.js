        ...
        api.get("shouqianba/recodeHistory", {
            ...
            $.when.apply($, deferreds).done(function() {
                ...
                pointHistories.forEach(function(pointHistory, i) {
                    ...
                    if (!order) order = {};
                    if (event.isIncreaseAction && pointHistory.amount < 0) console.warn(i, "Exception amount. the event is increase action, but amount less than 0");
                    var data = {
...
//# sourceMappingURL=ShouqianbaConsumeRecode.js.map