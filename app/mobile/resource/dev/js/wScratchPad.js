(function($) {
    ...
    ScratchPad.prototype = {
        ...
        reset: function() {
            var _this = this, width = Math.ceil(this.$el.innerWidth()), height = Math.ceil(this.$el.innerHeight()), devicePixelRatio = window.devicePixelRatio || 1;
        ...
        _scratchPercent: function() {
            var hits = 0, imageData = this.ctx.getImageData(0, 0, this.canvas.width, this.canvas.height);
    ...
    $.fn.wScratchPad = function(options, value) {
        ...
        if (typeof options === "string") {
            var wScratchPad, values = [], func = (value !== undefined ? "set" : "get") + options.charAt(0).toUpperCase() + options.substring(1), setOpt = function() {
...
//# sourceMappingURL=wScratchPad.js.map