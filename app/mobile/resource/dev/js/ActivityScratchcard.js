function ActivityScratchcard(opts) {
        ...
        scratchUp: function(e, percent) {
            if (percent > 30) {
                api.post("activity/open", {
                    ...
                    if (me.ticket.level != -1) me.history.load();
                });
    ...
    me.find(".activity-scratchcard-stores-toggle").click(function() {
        if (me.$stores.hasClass("activity-scratchcard-collapse")) {
            me.$stores.removeClass("activity-scratchcard-collapse").addClass("activity-scratchcard-expand").animate({
                height: me.storesHeightExpand
            });
            me.$storesToggleIcon.removeClass("fa-angle-down").addClass("fa-angle-up");
        } else {
            me.$stores.removeClass("activity-scratchcard-expand").addClass("activity-scratchcard-collapse").animate({
    ...
    api.get("activity/getLotteryActivity", {
        ...
        if (me.tried) {
            ...
            if (me.remaining == null || me.remaining > 0) me.draw();
        }
    });
}
...
//# sourceMappingURL=ActivityScratchcard.js.map