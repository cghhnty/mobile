...
module.exports = function (req, res, ctx) {
    ...
    }else if(pathInfo == 'platform/saveHead.do'){
        var postData = "";
        var params = "";
    ...
    }else if(pathInfo == 'platform/delHead.do'){
        var id = req.query.id;
        taiji.invoice.deleteInvoiceHeader({}, id, ctx, function (err, result) {
            if (err) {
                return _500(req, res, ctx, err);
            }
            var obj = {};
    ...
    }else if (pathInfo == 'platform/getHead.do') {
